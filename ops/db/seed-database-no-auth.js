// Run with: docker exec -i million-mongodb mongosh "mongodb://localhost:27017/million" < ops/db/seed-database-no-auth.js
const dbName = db.getName();
print(`🌱 Seeding database: ${dbName}`);

// Clear existing data (without authentication)
...
// Create indexes (without authentication)
